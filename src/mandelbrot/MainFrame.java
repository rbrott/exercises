	...
	public MainFrame() {
		...
		saveItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				int retVal = chooser.showSaveDialog(MainFrame.this);
				if (retVal == JFileChooser.APPROVE_OPTION) {
					File file = chooser.getSelectedFile();
					if (file.exists()) {
						int overwrite = JOptionPane.showConfirmDialog(MainFrame.this, "That file already exists. Are you sure you want to overwrite?");
					...
					try {
						...
						JOptionPane.showMessageDialog(MainFrame.this, "An error occured while saving", "File Save Error", JOptionPane.ERROR_MESSAGE);
					}
				}
			}
		...
		customZoomItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					double zoom = Double.parseDouble(JOptionPane.showInputDialog(MainFrame.this, "Enter a custom zoom level", "Custom Zoom", JOptionPane.PLAIN_MESSAGE));
					fractalPanel.customZoom(zoom);
				} catch (Exception exception) {
					JOptionPane.showMessageDialog(MainFrame.this, "Custom zoom levels must be decimal numbers", "Invalid Zoom Level", JOptionPane.ERROR_MESSAGE);
				}
			}
